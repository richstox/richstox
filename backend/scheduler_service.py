...
async def run_step2_event_detectors(
    ...
    return {
        "step_2_2_split": {
            ...
            "verified_through_date": split.get("dates_checked", [today_str])[-1] if split.get("dates_checked") else today_str,
        ...
        "step_2_4_dividend": {
            ...
            "verified_through_date": dividend.get("dates_checked", [today_str])[-1] if dividend.get("dates_checked") else today_str,
        ...
        "step_2_6_earnings": {
            ...
            "verified_through_date": earnings.get("dates_checked", [today_str])[-1] if earnings.get("dates_checked") else today_str,
