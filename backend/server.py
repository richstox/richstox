    ...
    async def _run_chain(chain_id: str) -> None:
        ...
        try:
            ...
            if chain_failed_step is None and chain_status == "failed":
                # Fallback inference for unexpected failures not caught above (best effort attribution; Step 2 handler sets failed_step explicitly, others rely on this branch).
